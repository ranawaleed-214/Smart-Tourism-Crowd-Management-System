...
namespace TourEgypt.Services
{
    public static class DataSeeder
    {
        public static PlaceList SeedPlaces()
        {
            ...
            var pyramids = new TouristAttraction(1, "Pyramids of Giza", "Giza, Cairo", "One of the Seven Wonders of the Ancient World.", new TimeSpan(8, 0, 0), new TimeSpan(17, 0, 0), 5, 8);
            ...
            var museum = new TouristAttraction(2, "Egyptian Museum", "Tahrir Square, Cairo", "Home to the world largest collection of ancient Egyptian artifacts.", new TimeSpan(9, 0, 0), new TimeSpan(17, 0, 0), 3, 6);
            ...
            var khan = new TouristAttraction(3, "Khan El Khalili", "Islamic Cairo", "Famous bazaar and souq in the heart of historic Cairo.", new TimeSpan(10, 0, 0), new TimeSpan(22, 0, 0), 2, 4);
            ((DataSimulator)khan.Counter).SimulateHour();
            khan.AddReview(new Review("Mike Johnson", 5, "Best shopping experience ever!"));
            list.AddPlace(khan);

            var luxor = new TouristAttraction(4, "Luxor Temple", "Luxor, Upper Egypt", "Ancient temple complex on the east bank of the Nile.", new TimeSpan(6, 0, 0), new TimeSpan(22, 0, 0), 4, 5);
            ((DataSimulator)luxor.Counter).SimulateHour();
            list.AddPlace(luxor);

            var saqqara = new TouristAttraction(5, "Saqqara", "Saqqara, Giza", "Step Pyramid of Djoser and ancient necropolis.", new TimeSpan(8, 0, 0), new TimeSpan(16, 0, 0), 4, 3);
